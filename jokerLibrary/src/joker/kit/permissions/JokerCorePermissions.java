 ...
 */
public final class JokerCorePermissions {

    private Activity mActivity;
    private List<String> mPermissions = new ArrayList<>();
    private boolean mConstant;

    private JokerCorePermissions(Activity activity) {
        mActivity = activity;
    }
     ...
     * 设置请求的对象
     */
    public static JokerCorePermissions with(Activity activity) {
        return new JokerCorePermissions(activity);
    }

    /**
     * 设置权限组
     */
    public JokerCorePermissions permission(String... permissions) {
     ...
     * 设置权限组
     */
    public JokerCorePermissions permission(List<String> permissions) {
     ...
     * 被拒绝后继续申请，直到授权或者永久拒绝
     */
    public JokerCorePermissions constantRequest() {
        mConstant = true;
        return this;
    }
